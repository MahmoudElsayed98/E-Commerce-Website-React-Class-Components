      ...
      <div className="about py-4">
        <div className="container d-flex flex-column justify-content-center align-items-center">
          ...
          <p className="text-center text-md-start mb-0 lead">
            ...
            options for any area of your store. e-commerce has the impressive
            rating of 4.9 from more than 2000 ratings. e-commerce 3 also comes
            with fully customizable CSS options with the added possibility of
            setting each option differently on any breakpoint. This breakthrough
            feature will greatly enhance your design skills and allow you to
            create pixel perfect layouts at any screen width. The new advanced
            Status mechanism allow you to set up modules and menus based on
            device, customer login status or customer groups. 98% satisfaction
            rate within our more than 19,000 customers. The new Schedule feature
            ...
            features available in the new e-commerce 3 framework, there are so
            many new options and possibilities that it will takes us a very long
